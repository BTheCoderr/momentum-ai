...
if (!supabaseUrl || !supabaseServiceKey) {
  ...
  console.log('Please ensure EXPO_PUBLIC_SUPABASE_URL and SUPABASE_SERVICE_ROLE_KEY are set');
  process.exit(1);
}
      ...
      try {
        ...
        if (error) {
          ...
          if (directError) {
            ...
            // For table creation and schema changes, we might need to use a different approach
